...
#define PIN_PWM 45 //sur l'arduino mega adk, le pin 45 est compatible PWM
...
void loop() {
  if (acc.isConnected()) {
    ...
    if(len > 0){
      ...
      analogWrite(PIN_PWM, 100 + vitesse); //la voiture demarre a 120
    }
